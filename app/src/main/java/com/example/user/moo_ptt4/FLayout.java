...
public class FLayout extends ViewGroup implements View.OnClickListener {
    ...
    private FLayoutListener mFlowLayoutListener;
     ...
     * 标签点击的回调
     */
    public interface  FLayoutListener{
    ...
    public FLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs, com.nex3z.flowlayout.R.styleable.FlowLayout, 0, 0);
        try {
            mFlow = a.getBoolean(com.nex3z.flowlayout.R.styleable.FlowLayout_flFlow, DEFAULT_FLOW);
            try {
                mChildSpacing = a.getInt(com.nex3z.flowlayout.R.styleable.FlowLayout_flChildSpacing, DEFAULT_CHILD_SPACING);
            } catch (NumberFormatException e) {
                mChildSpacing = a.getDimensionPixelSize(com.nex3z.flowlayout.R.styleable.FlowLayout_flChildSpacing, (int)dpToPx(DEFAULT_CHILD_SPACING));
            }
            try {
                mMinChildSpacing = a.getInt(com.nex3z.flowlayout.R.styleable.FlowLayout_flMinChildSpacing, DEFAULT_CHILD_SPACING);
            } catch (NumberFormatException e) {
                mMinChildSpacing = a.getDimensionPixelSize(com.nex3z.flowlayout.R.styleable.FlowLayout_flMinChildSpacing, (int)dpToPx(DEFAULT_CHILD_SPACING));
            }
            try {
                mChildSpacingForLastRow = a.getInt(com.nex3z.flowlayout.R.styleable.FlowLayout_flChildSpacingForLastRow, SPACING_UNDEFINED);
            } catch (NumberFormatException e) {
                mChildSpacingForLastRow = a.getDimensionPixelSize(com.nex3z.flowlayout.R.styleable.FlowLayout_flChildSpacingForLastRow, (int)dpToPx(DEFAULT_CHILD_SPACING));
            }
            try {
                mRowSpacing = a.getInt(com.nex3z.flowlayout.R.styleable.FlowLayout_flRowSpacing, 0);
            }  catch (NumberFormatException e) {
                mRowSpacing = a.getDimension(com.nex3z.flowlayout.R.styleable.FlowLayout_flRowSpacing, dpToPx(DEFAULT_ROW_SPACING));
            }
            mMaxRows = a.getInt(com.nex3z.flowlayout.R.styleable.FlowLayout_flMaxRows, DEFAULT_MAX_ROWS);
            mRtl = a.getBoolean(com.nex3z.flowlayout.R.styleable.FlowLayout_flRtl, DEFAULT_RTL);
            mGravity = a.getInt(com.nex3z.flowlayout.R.styleable.FlowLayout_android_gravity, UNSPECIFIED_GRAVITY);
        } finally {
            a.recycle();
        }
    }
...
//            int childgetMeasuredWidth = child.getMeasuredWidth();
//           if (childgetMeasuredWidth > 500){
//               childgetMeasuredWidth = 500;
//           }
            int childWidth = child.getMeasuredWidth() + horizontalMargin;
           // int childWidth = childgetMeasuredWidth + horizontalMargin;
            int childHeight = child.getMeasuredHeight() + verticalMargin;
//            Log.i("childWidth","childWidth : " + childWidth);
//            Log.i("child.getMeasuredWidth()","child.getMeasuredWidth() : " + child.getMeasuredWidth());
//            Log.i("childWidth","horizontalMargin : " + horizontalMargin);
     ...
     *
     * @return The spacing, either {@link com.nex3z.flowlayout.FlowLayout#SPACING_AUTO}, or a fixed size in pixels.
     */
     ...
     *
     * @param childSpacing The spacing, either {@link com.nex3z.flowlayout.FlowLayout#SPACING_AUTO}, or a fixed size in
     *        pixels.
     */
     ...
     *
     * @return The spacing, either {@link com.nex3z.flowlayout.FlowLayout#SPACING_AUTO},
     *         {@link com.nex3z.flowlayout.FlowLayout#SPACING_ALIGN}, or a fixed size in pixels
     */
     ...
     *
     * @param childSpacingForLastRow The spacing, either {@link com.nex3z.flowlayout.FlowLayout#SPACING_AUTO},
     *        {@link com.nex3z.flowlayout.FlowLayout#SPACING_ALIGN}, or a fixed size in pixels
     */
     ...
     * 添加数据
     */
    public void addData(List<Integer> datas){
        for(Integer data: datas){
            addTextView(data);
        }
        requestLayout();
    }
    public void setFlowLayoutListener(FLayoutListener flowLayoutListener){
    ...
    public void onClick(View view) {
        for (int i = 0;i<getChildCount();i++){
            if(getChildAt(i)==view){
                mFlowLayoutListener.onItemClick(view,i);
                break;
            }
        }
    }
     ...
     * @param str
     */
    private void addTextView(Integer str) {
